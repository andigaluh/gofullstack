...
$(document).ready(function() {		
	...
	Morris.Line({
	  ...
	  data: [
		{ y: '2018-01-07', a: 1050, b: 1240, c: 1500 },
		{ y: '2018-01-08', a: 1165,  b: 1255, c: 1453 },
		{ y: '2018-01-09', a: 1150,  b: 1240, c: 1776 },
		{ y: '2018-01-10', a: 1075,  b: 1365, c: 1994 },
		{ y: '2018-01-11', a: 1250,  b: 1840, c: 1143 },
		{ y: '2018-01-12', a: 1775,  b: 1965, c: 1004 },
		{ y: '2018-01-13', a: 1000, b: 900, c: 1240 }
	  ],
	  xkey: 'y',
	  ykeys: ['a', 'b', 'c'],
	  labels: ['Active apps', 'Active lockscreen','Active users'],
	  lineColors:['#0aa699','#d1dade','#0090d9'],
	});
	
	Morris.Area({
	  element: 'area-example',
	  data: [
		{ y: '2018-01-07', a: 100, b: 90 },
		{ y: '2018-01-08', a: 75,  b: 65 },
		{ y: '2018-01-09', a: 50,  b: 40 },
		{ y: '2018-01-10', a: 75,  b: 65 },
		{ y: '2018-01-11', a: 50,  b: 40 },
		{ y: '2018-01-12', a: 75,  b: 65 },
		{ y: '2018-01-13', a: 100, b: 90 }
	  ],
	  xkey: 'y',
	  ykeys: ['a', 'b'],
	  labels: ['opportunity impression', 'field impression'],
